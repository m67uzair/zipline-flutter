    ...
    return ScreenUtilInit(
        ...
        builder: (BuildContext context, Widget? child) {
          return GetMaterialApp(
            ...
            initialRoute:
                prefs.getInt(UserContants.userId) == null ? AppRoutes.getProfileRoute() : AppRoutes.getAllItemRoute(),
            // !firstLogin ? AppRoutes.getLoginRoute() : AppRoutes.getIntroRoute(),
            initialBinding: prefs.getInt(UserContants.userId) == null ? ProfileBinding() : AllItemBinding(),
